      ...
      <div className="px-4 py-8 max-w-6xl mx-auto">
        ...
        <div className="mb-6 flex flex-wrap gap-2">
          <Button
            ...
            className={`px-4 py-2 ${activeFilter === 'all' ? 'bg-purple-600' : 'bg-gray-700'}`}
          >
            Todos
          </Button>
          <Button
            onClick={() => setActiveFilter('pc')}
            className={`px-4 py-2 ${activeFilter === 'pc' ? 'bg-purple-600' : 'bg-gray-700'}`}
          >
            PC
          </Button>
          <Button
            onClick={() => setActiveFilter('console')}
            className={`px-4 py-2 ${activeFilter === 'console' ? 'bg-purple-600' : 'bg-gray-700'}`}
          >
            Consola
          </Button>
          <Button
            onClick={() => setActiveFilter('board')}
            className={`px-4 py-2 ${activeFilter === 'board' ? 'bg-purple-600' : 'bg-gray-700'}`}
          >
            Juegos de Mesa
          </Button>
        </div>
